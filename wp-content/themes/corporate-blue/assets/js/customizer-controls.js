...
jQuery( document ).ready(function($) {
    ...
    $(".corporate-blue-chosen-select").chosen({
        width: "100%"
    });
    ...
    $( document ).on( 'click', '.customize_multi_add_field', corporate_blue_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', corporate_blue_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', corporate_blue_customize_multi_remove_field )
    ...
    function corporate_blue_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            corporate_blue_customize_multi_write( $control );
    }

    function corporate_blue_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        corporate_blue_customize_multi_write( $control );
    }

    function corporate_blue_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function corporate_blue_customize_multi_write( $element) {
